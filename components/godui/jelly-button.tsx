...
export type JellyButtonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
   ...
   * Drives the `--jelly-press` scale the button snaps to.
   * @default 0.6
   */
  squash?: number;
};
...
const sizeClasses: Record<JellyButtonSize, string> = {
  ...
  lg: "rounded-[var(--button-radius-lg)] px-[var(--button-px-lg)] py-[var(--button-px-lg)] text-[length:var(--button-text-lg)] leading-[var(--button-leading-lg)]",
};
